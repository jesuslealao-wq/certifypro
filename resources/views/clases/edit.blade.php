...
@section('page-description', 'Modificar información de la clase')
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('clases.update', $clase) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <select name="modulo_id" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                    ...
                    @foreach($modulos as $modulo)
                        <option value="{{ $modulo->id }}" {{ old('modulo_id', $clase->modulo_id) == $modulo->id ? 'selected' : '' }}>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="titulo_clase" value="{{ old('titulo_clase', $clase->titulo_clase) }}" 
            ...
            <div class="mb-4">
                ...
                <input type="number" name="orden" value="{{ old('orden', $clase->orden) }}" 
                    class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" 
                    min="1">
                @error('orden')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
